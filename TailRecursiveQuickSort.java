...
public class TailRecursiveQuickSort {
    ...
    public static void tail_recursive_quicksort(int[] array, int p, int r) {
    ...
    public static void main(String[] args) {
        ...
        // perform tail recursive quicksort on unsorted array
        System.out.println("\nStack Depth of tail recursive quick sort (depth of recursion) is - ");
        tail_recursive_quicksort(array, 1, array.length - 1);
